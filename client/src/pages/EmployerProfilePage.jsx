                                        ...
                                        <Table hover responsive className="mb-0 align-middle">
                                            <thead className="table-light">
                                                <tr>
                                                    <th>#</th>
                                                    <th>Студент</th>
                                                    <th className="d-none d-md-table-cell">Email/Телефон</th>
                                                    <th>Вакансия</th>
                                                    <th>Статус</th>
                                                    <th className="d-none d-sm-table-cell">Дата</th>
                                                    {/* <th>Действия</th> */}
                                                    {/* <th>Отзыв</th> */}
                                                </tr>
                                            </thead>
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td style={{ minWidth: 120 }}>
                                                                <div className="fw-semibold text-truncate" style={{ maxWidth: 120 }}>{app.studentName || `Студент #${app.studentId || "-"}`}</div>
                                                                <div className="small text-muted">ID: {app.studentId || "-"}</div>
                                                                {app.studentSkills && (
                                                                    <div className="small text-muted text-truncate" style={{ maxWidth: 120 }}>
                                                                        Навыки: {app.studentSkills}
                                                                    </div>
                                                                )}
                                                            </td>
                                                            <td className="d-none d-md-table-cell" style={{ minWidth: 120 }}>
                                                                {app.studentEmail && (
                                                                    <div className="small">
                                                            ...
                                                            <td className="text-muted small d-none d-sm-table-cell">{formatDate(app.createdAt)}</td>
                                                        </tr>
                                                    );
                                                })}
                                            </tbody>
