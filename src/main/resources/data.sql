...
SELECT setval(pg_get_serial_sequence('employer', 'id'), (SELECT MAX(id) FROM employer));
SELECT setval(pg_get_serial_sequence('student_profile', 'id'), (SELECT MAX(id) FROM student_profile));
SELECT setval(pg_get_serial_sequence('vacancy', 'id'), (SELECT MAX(id) FROM vacancy));